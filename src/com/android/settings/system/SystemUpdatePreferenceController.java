...
public class SystemUpdatePreferenceController extends BasePreferenceController {
    ...
    private static final String OTA_BUILD_TYPE_PROP = "org.edgeration.ota.build";
    private static final String OTA_APP_PACKAGE = "org.edgeration.ota";
    ...
    public int getAvailabilityStatus() {
        String buildtype = SystemProperties.get(OTA_BUILD_TYPE_PROP,"false");
        if (!mUm.isAdminUser() || !buildtype.equalsIgnoreCase("true")){
